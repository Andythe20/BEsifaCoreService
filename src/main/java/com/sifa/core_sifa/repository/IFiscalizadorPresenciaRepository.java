...
import com.sifa.core_sifa.model.FiscalizadorPresenciaId;
...
@Repository
public interface IFiscalizadorPresenciaRepository
                extends JpaRepository<FiscalizadorPresencia, FiscalizadorPresenciaId> {

        /**
         * Busca los inspectores activos en los últimos 10 minutos,
         * devolviendo estrictamente su última ubicación conocida (un solo registro por
         * inspector).
         */
